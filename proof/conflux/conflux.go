...
import (
	...
	"github.com/mapprotocol/compass-sdk/proof/conflux/mpt"
	primitives "github.com/mapprotocol/compass-sdk/proof/conflux/primipives"
	"github.com/mapprotocol/compass-sdk/proof/conflux/types"
...
func AssembleProof(client *Client, txHash common.Hash, epochNumber, pivot uint64, method string, fId constant.ChainId) ([]byte, error) {
	...
	input, err := constant.Conflux.Methods[constant.MethodOfVerifyReceiptProof].Inputs.Pack(proof)
	if err != nil {
		return nil, err
	}
