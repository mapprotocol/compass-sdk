...
func GetByReceipt(receipts types.Receipts, txIndex uint) ([][]byte, error) {
...
func Get(receipts types.DerivableList, txIndex uint) ([][]byte, error) {
	tr, err := trie.New(common.Hash{}, trie.NewDatabase(memorydb.New()))
	if err != nil {
		return nil, err
	}
...
func DeriveTire(rs types.DerivableList, tr *trie.Trie) *trie.Trie {
